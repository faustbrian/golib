...
required=(
	...
	docs/README.md docs/api.md docs/laravel-migration.md docs/kubernetes.md
	docs/leases.md docs/time-and-missed-runs.md docs/dispatch-and-idempotency.md
	docs/operations.md docs/security.md docs/troubleshooting.md
	docs/compatibility.md docs/performance.md docs/faq.md
)
