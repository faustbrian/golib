...
| Compatibility and wire consequences | Schema-incompatible example values remain round-trippable and do not make an otherwise valid description invalid. A future assertion API must be opt-in and cannot silently change `validate.Document`. |
