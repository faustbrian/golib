...
- **Interpretations and peer behavior:** Reimplement every grammar, expose
  ...
  ordering.
- **Selected behavior and consequences:** JSON and XML delegate syntax and Go
...
- **Selected behavior and consequences:** JSON, XML, SOAP, YAML, MessagePack,
...
- **Selected behavior and consequences:** Zero selects a 1 MiB input and
...
- **Selected behavior and consequences:** `DetectFormat` recognizes only a
...
- **Selected behavior and consequences:** Decode requires valid UTF-8 and one
...
- **Selected behavior and consequences:** Strict parsing, one root, resolved
...
- **Selected behavior and consequences:** The namespace selects exactly SOAP
...
- **Interpretations and peer behavior:** Use permissive YAML 1.1 typing, reject
  ...
  limits.
- **Selected behavior and consequences:** Use `go.yaml.in/yaml/v4` v4 defaults,
...
- **Selected behavior and consequences:** `BurntSushi/toml` v1.6.0 parses one
...
- **Selected behavior and consequences:** Exactly one object is required.
...
- **Selected behavior and consequences:** `Canonical` means RFC 7049 section
...
- **Selected behavior and consequences:** APIs require exactly one complete
...
- **Interpretations and peer behavior:** Claim every encoder is canonical,
  ...
  value shape.
- **Selected behavior and consequences:** JSON, YAML, TOML, and MessagePack
...
- **Selected behavior and consequences:** `wire.Error` classifies parse,
...
- **Selected behavior and consequences:** Every typed encoder rejects cycles
...
- **Selected behavior and consequences:** `wire` owns bounded byte and
