...
| `verkletree-bandersnatch-ipa-256-v0` | Package-owned experimental identity | Incremental pre-v1 implementation | Public immutable in-memory snapshots, canonical set/delete transitions, profile-bound roots, and aggregate membership/non-membership proofs over internal canonical topology, bounded vector commitments, strict encodings, and independent verifier reconstruction; no stable wire, witness, storage, production, or Ethereum compatibility |
