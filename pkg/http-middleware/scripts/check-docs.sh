...
required=(
	...
	docs/behavior.md docs/responsewriter.md docs/standards.md docs/dependencies.md
	docs/verification.md docs/adoption.md
	docs/integrations.md docs/ownership.md docs/migration.md docs/cookbook.md
