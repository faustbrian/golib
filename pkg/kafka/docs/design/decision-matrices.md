...
| Keys | Require an explicit keyed or unkeyed policy; allow explicit partitions through a separate reviewed surface. | A zero-value key cannot accidentally opt into unkeyed production when keying is required. |
