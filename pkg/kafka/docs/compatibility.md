...
| Mutation tool | patched Gremlins v0.6.0 | 854 of 854 viable mutants killed; 100% efficacy and mutator coverage on 2026-07-26 |
...
- [Apache Kafka documentation](https://kafka.apache.org/documentation/) and
  [supported downloads](https://kafka.apache.org/community/downloads/);
