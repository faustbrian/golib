...
| Mutation tool | patched Gremlins v0.6.0 | 2,107 of 2,107 viable mutants killed; 100% efficacy and mutator coverage on 2026-07-27 |
...
| Observability | Producer, consumer, rebalance, transaction, replay, inspection, and lifecycle events plus optional adapters | Root payload-free producer delivery, nontransactional consumer record/batch/commit/poll, and producer/consumer broker connection/request/throttle/disconnect events are deterministically tested. Real-broker connection and request emission is exercised by the compatibility fixture. Standalone authentication, rebalance, transaction-processor, replay, inspection, health/shutdown lifecycle, OpenTelemetry, and slog coverage remains unimplemented. |
