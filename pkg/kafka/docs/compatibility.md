...
| Mutation tool | patched Gremlins v0.6.0 | 1,656 of 1,656 viable mutants killed; 100% efficacy and mutator coverage on 2026-07-26 |
...
| Inspection/health | Cluster/topic/group/durability and separated health signals | Single-broker cluster/controller, topic replica/ISR/offline, beginning/end offset, effective `min.insync.replicas`, lag, and bounded dependency-ping evidence; group assignments, multi-broker faults, and separated stateful health policy remain unverified |
