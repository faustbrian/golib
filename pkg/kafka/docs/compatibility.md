...
| Mutation tool | patched Gremlins v0.6.0 | 1,771 of 1,771 viable mutants killed; 100% efficacy and mutator coverage on 2026-07-26 |
...
| Inspection/health | Cluster/topic/group/durability and separated health signals | Single-broker cluster/controller, topic replica/ISR/offline, beginning/end offset, effective `min.insync.replicas`, classic-group lag/member assignment, dependency health, local liveness, and readiness-hysteresis evidence; KIP-848 inspection, multi-broker faults, and complete service health composition remain unverified |
