...
| Mutation tool | patched Gremlins v0.6.0 | 1,910 of 1,910 viable mutants killed; 100% efficacy and mutator coverage on 2026-07-27 |
...
| Observability | Producer, consumer, rebalance, transaction, replay, inspection, and lifecycle events plus optional adapters | Root payload-free producer delivery and nontransactional consumer record, batch, commit, and poll completion events are deterministically tested. Broker/request, rebalance, transaction, replay, inspection, lifecycle, OpenTelemetry, and slog coverage remains unimplemented. |
