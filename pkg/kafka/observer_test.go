...
func TestObservationKindString(t *testing.T) {
	...
	for kind, want := range map[ObservationKind]string{
		...
		ObservationInspectorCluster:             "inspector.cluster",
		ObservationInspectorTopics:              "inspector.topics",
		ObservationInspectorConsumerGroups:      "inspector.consumer_groups",
		ObservationDependencyHealth:             "inspector.dependency_health",
		ObservationReadiness:                    "inspector.readiness",
		ObservationInspectorShutdown:            "inspector.shutdown",
...
func TestObservationKindValuesRemainStable(t *testing.T) {
	...
	for kind, want := range map[ObservationKind]ObservationKind{
		...
		ObservationInspectorCluster:             24,
		ObservationInspectorTopics:              25,
		ObservationInspectorConsumerGroups:      26,
		ObservationDependencyHealth:             27,
		ObservationReadiness:                    28,
		ObservationInspectorShutdown:            29,
