...
the delete, ordinary mutations have no distributed generation fence. Include a
source version in the key/value or coordinate invalidation at the application
boundary. For a leased Valkey refresh, publish only through `SetIfOwned`.
