...
// xsdUnicodeBlocks is the Unicode block inventory required by XML Schema 1.0
// Second Edition. Specials is intentionally discontinuous in the normative
// table.
var xsdUnicodeBlocks = map[string]runeSet{
