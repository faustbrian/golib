...
var (
	...
	ErrConsumerRequired = errors.New(
		"event-sourcing/goqueue: delivery consumer is required",
	)
	// ErrTaskRequired reports a missing queue task.
	ErrTaskRequired = errors.New(
		"event-sourcing/goqueue: task is required",
	)
