...
| Repository quality gates | Current 142-module catalog and 111-module `v1.0.0` rehearsal verified | [Quality](quality.md), [CI](ci.md), and [hardening report](hardening-report.md) |
