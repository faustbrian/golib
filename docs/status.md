...
| Repository quality gates | 138-module baseline verified; four integrated modules pending fresh matrix proof | [Quality](quality.md), [CI](ci.md), and [hardening report](hardening-report.md) |
