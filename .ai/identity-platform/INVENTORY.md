...
| `organization` | `pkg/organization` | `identity`<br>`identity/session`<br>`identity/delivery` | proposed | — | `goals/organization.md` |
...
| `sso/postgres` | `pkg/sso/postgres` | `sso`<br>`sso/oidc`<br>`sso/oauth2`<br>`sso/saml`<br>`identity/postgres`<br>`organization/postgres` | proposed | — | `goals/sso-postgres.md` |
